...
let handler = async (m, { conn, text }) => {
  ...
  try {
    ...
    else throw 'Baka!!! Have you ever seen anyone use the word #help?'
  }
}
handler.help = ['wm <packname>|<author>']
handler.tags = ['sticker']
handler.command = /^wm|s|sticker$/i
