...
└─────────────────⸙ \n\ ______`
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch("https://telegra.ph/file/4bd12722910126f07ef7c.jpg")).buffer(), text.trim(), '© ᴍᴏɴᴏʟɪᴛʜ ©', '✪ ʙᴏᴛ ᴏᴡɴᴇʀ ✪', '.owner', '✪ ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅs ✪', '.?', m)
  } catch (e) {
