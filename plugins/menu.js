...
└─────────────────⸙ \n\ ______`
          ...
          "sections": [
            {
              "rows": [
                ...
                "rowId": ".? anime"
                  ...
                  "title": "🎐sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ🎐",
                  "description": "ᴍᴏɴᴏʟɪᴛʜ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ",
                  "rowId": `.support`
                }, {
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch("https://telegra.ph/file/32f4ce6edbbc37650f987.jpg")).buffer(), text.trim(), '© ᴍᴏɴᴏʟɪᴛʜ ×፝֟͜×', '✪ ʙᴏᴛ ᴏᴡɴᴇʀ ✪', '.owner', '✪ ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅs ✪', '.?', m)
  } catch (e) {
