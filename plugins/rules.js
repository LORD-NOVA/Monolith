...
│4. The bot/owner is not responsible for what the user does with the bot commands
│5. Don't call / vc bot numbers
│6. EXP/Limit/Level cheats are prohibited
│7. If the bot doesn't respond, it means it's off or under maintenance
│8. Please report any bugs via *!report*
└────

 「 ᴄᴏɴsᴇǫᴜᴇɴᴄᴇs 」
│1. If you violate rule number 5 (calling) you will be blocked
│2. If you violate the rules number 1, 2, 3 then you will get banned from using my bots
│4. If you violate rule number 3 (insulting) then it will be directed to your homes 
└────
